...
export function formatLabFlowAdminErrorMessage(error: unknown): string {
  if (error instanceof ApiRequestError) {
    ...
    if (error.code === "NOT_FOUND") {
      return error.message || "Curriculum, step, or lab was not found";
    }

    if (error.code === "CONFLICT") {
      return error.message || "Curriculum already exists for this lab";
    }
